...
If you get permissions issues "sudo npm..." might work but usually you should try to configure the right [premissions](http://competa.com/blog/2014/12/how-to-run-npm-without-sudo/) instead. You could also install locally.
