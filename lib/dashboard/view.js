...
function initUI() {
   ...
   this.grid = new contrib.grid({rows: 6, cols: 6})     
   this.screen = blessed.screen()
   this.grid.set(0, 1, 2, 2, contrib.line, 
     { style: 
       { line: "yellow"
       , text: "green"
       , baseline: "black"}
   ...
   this.grid.set(2, 0, 2, 2, contrib.line, 
     { style: 
       { line: "blue"
       , text: "green"
       , baseline: "black"}
   ...
   this.grid.set(0, 5, 1, 2, contrib.line, 
     { style: 
       { line: "blue"
       , text: "green"
       , baseline: "black"}
  ...
  this.grid.set(0, 0, 1, 2, blessed.box, 
     { style: 
       { line: "blue"
       , text: "green"
       , baseline: "black"}
   ...
   this.grid.set(0, 3, 2, 2, contrib.map, {label: 'Load Locations'})

   this.grid.set(5, 0, 2, 1, contrib.line, 
     { style: 
       { line: "red"
       , text: "white"
       , baseline: "black"}
    ...
    this.grid.set(2, 2, 4, 3, contrib.line, 
     { style: 
       { line: "blue"
       , text: "green"
       , baseline: "black"}
     ...
     this.grid.set(4, 0, 2, 1, contrib.table, 
      { keys: true
      , fg: 'green'
     ...
     this.grid.set(5, 2, 4, 1, contrib.table, 
      { keys: true
      , fg: 'green'
      , label: 'Errors'
    ...
    var grid = this.grid
    grid.applyLayout(this.screen)

    this.vusers = grid.get(0, 1)
    this.hits = grid.get(2, 0)   
    this.throughput = grid.get(0, 5)   
    this.map = grid.get(0, 3)   
    this.errors = grid.get(5, 0)
    this.trt = grid.get(2, 2)      
    this.tpst = grid.get(4, 0)
    this.errorsTable = grid.get(5, 2)
    this.statusBox = grid.get(0, 0)    
